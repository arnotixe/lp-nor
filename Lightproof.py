...
from lightproof_impl_nb_NO import locales
from lightproof_impl_nb_NO import pkg
import lightproof_handler_nb_NO
...
# check settings
def option(lang, opt):
    return lightproof_handler_nb_NO.get_option(lang.Language + "_" + lang.Country, opt)
...
g_ImplementationHelper.addImplementation( lightproof_handler_nb_NO.LightproofOptionsEventHandler, \
