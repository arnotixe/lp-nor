...
from lightproof_impl_en_US import locales
from lightproof_impl_en_US import pkg
import lightproof_handler_en_US
...
# check settings
def option(lang, opt):
    return lightproof_handler_en_US.get_option(lang.Language + "_" + lang.Country, opt)
...
class Lightproof( unohelper.Base, XProofreader, XServiceInfo, XServiceName, XServiceDisplayName, XSupportedLocales):
    ...
    def __init__( self, ctx, *args ):
        ...
        lightproof_handler_en_US.load(currentContext)
...
g_ImplementationHelper.addImplementation( lightproof_handler_en_US.LightproofOptionsEventHandler, \
